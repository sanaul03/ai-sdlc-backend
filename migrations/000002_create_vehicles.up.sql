CREATE TABLE vehicles (
    ...
    CONSTRAINT vehicles_licence_plate_key UNIQUE (licence_plate),
    ...
    CONSTRAINT vehicles_car_group_id_fkey FOREIGN KEY (car_group_id) REFERENCES car_groups (id),
    CONSTRAINT vehicles_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES branches (id)
);

CREATE INDEX vehicles_car_group_id_idx ON vehicles (car_group_id);
...
CREATE INDEX vehicles_designation_idx ON vehicles (designation);
